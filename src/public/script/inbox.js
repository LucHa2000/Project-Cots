...
socket.on("new-message-private-emotion", (data) => {
  ...
  $("#chat-content").append(
    ...
    //   data.sender +
    //   ":" +
    //   '<img class="image-infor-focus" src=' +
    //   data.message +
    //   "></h6>"

    '<div class="message-container-receive"><img class="image-infor-focus" src ="' +
      data.message +
      '"><h6 class="nameUser">' +
      data.sender +
      "</h6></div>"
...
socket.on("new-message-private", (data) => {
  ...
  receiver = data.sender;
  $("#chat-content").append(
    '<div class="message-container-receive"><p class="text-message>' +
      data.message +
      '">' +
      '<h6 class="nameUser">' +
      data.sender +
